...
class AIService {
     ...
     */
    static async generateNutritionPlan(profile, ingredients) {
        const prompt = `
...
`;
     ...
     */
    static async generateFitnessPlan(profile, weeklyGoal) {
        const prompt = `
...
`;
    ...
    static fallbackNutritionPlanner(profile, ingredients) {
    ...
    static fallbackFitnessPlanner(profile, weeklyGoal) {
