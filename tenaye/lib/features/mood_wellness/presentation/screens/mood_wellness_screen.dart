      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // Header Segment
              const Text('Mood & Wellness', style: AppTextStyles.mainTitle),
              const SizedBox(height: 4),
              const Text('Track how you feel each day', style: AppTextStyles.bodySecondary),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: AppColors.primaryGreen.withOpacity(0.5), // Match unsubmitted dim blend
